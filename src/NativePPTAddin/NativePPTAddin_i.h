...
#ifndef __NativePPTAddin_i_h__
#define __NativePPTAddin_i_h__
...
EXTERN_C const IID IID_IConnect;
    ...
    MIDL_INTERFACE("3aba0b66-a87b-45dd-9ded-da9637fb88d8")
...
#ifndef __NativePPTAddinLib_LIBRARY_DEFINED__
#define __NativePPTAddinLib_LIBRARY_DEFINED__

/* library NativePPTAddinLib */
/* [version][uuid] */ 


EXTERN_C const IID LIBID_NativePPTAddinLib;

EXTERN_C const CLSID CLSID_Connect;

#ifdef __cplusplus

class DECLSPEC_UUID("076d6ae3-6180-44c1-84db-319a3840cefb")
Connect;
#endif
#endif /* __NativePPTAddinLib_LIBRARY_DEFINED__ */
...
EXTERN_C const IID IID_IRibbonCallback;
    ...
    public:
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE GetLabel( 
            ...
            /* [retval][out] */ BSTR *pbstrReturnedVal) = 0;
        
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE GetVisible( 
            /* [in] */ IDispatch *pControl,
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE CustomUILoadImage( 
    ...
    typedef struct IRibbonCallbackVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *GetLabel )( 
            IRibbonCallback * This,
            /* [in] */ IDispatch *pControl,
            /* [retval][out] */ BSTR *pbstrReturnedVal);
        
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *GetVisible )( 
            IRibbonCallback * This,
            /* [in] */ IDispatch *pControl,
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *CustomUILoadImage )( 
            IRibbonCallback * This,
            /* [in] */ BSTR *pbstrImageId,
            /* [retval][out] */ IPictureDisp **ppdispImage);
...
#define IRibbonCallback_GetLabel(This,pControl,pbstrReturnedVal)	\
    ( (This)->lpVtbl -> GetLabel(This,pControl,pbstrReturnedVal) ) 

#define IRibbonCallback_GetVisible(This,pControl,pvarReturnedVal)	\
    ( (This)->lpVtbl -> GetVisible(This,pControl,pvarReturnedVal) ) 

#define IRibbonCallback_GetImage(This,pControl,ppdispImage)	\
    ( (This)->lpVtbl -> GetImage(This,pControl,ppdispImage) ) 

#define IRibbonCallback_CustomUILoadImage(This,pbstrImageId,ppdispImage)	\
    ( (This)->lpVtbl -> CustomUILoadImage(This,pbstrImageId,ppdispImage) ) 
